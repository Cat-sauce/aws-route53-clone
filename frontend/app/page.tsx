    ...
    <div className="min-h-screen bg-white text-[#161e2e] flex flex-col font-sans">
      ...
      <header className="bg-[#161e2e] text-gray-300 text-xs py-2 px-6 flex items-center justify-between border-b border-gray-800">
        <div className="flex items-center space-x-6">
          ...
          <Link href="/signin" className="hover:text-white transition">Contact us</Link>
          <Link href="/signin" className="hover:text-white transition">AWS Marketplace</Link>
      ...
      <section className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="flex items-center space-x-3">
          ...
          <Link
            href="/signin"
            className="px-5 py-2.5 border border-gray-400 hover:border-black text-[#161e2e] text-xs font-bold rounded-full transition"
          >
      ...
      <section className="max-w-6xl mx-auto px-6 py-10 border-t border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="relative rounded-2xl overflow-hidden bg-gradient-to-tr from-gray-900 to-gray-800 text-white min-h-[300px] flex flex-col justify-end p-8 shadow-md group">
          ...
          <div className="relative rounded-2xl overflow-hidden bg-gradient-to-tr from-[#a67c1e] to-[#2c220f] text-white min-h-[300px] flex flex-col justify-end p-8 shadow-md group">
            <div className="absolute inset-0 bg-black/40 z-0"></div>
            <div className="relative z-10 space-y-3">
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 border-t border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Link href="/console" className="p-6 rounded-2xl bg-gradient-to-b from-[#0c2340] to-[#040e1a] text-white hover:scale-[1.02] transition shadow-md flex flex-col justify-between h-52">
          ...
          <Link href="/signin" className="p-6 rounded-2xl bg-gradient-to-b from-[#87201c] to-[#360807] text-white hover:scale-[1.02] transition shadow-md flex flex-col justify-between h-52">
          ...
          <Link href="/console" className="p-6 rounded-2xl bg-gradient-to-b from-[#113a36] to-[#061817] text-white hover:scale-[1.02] transition shadow-md flex flex-col justify-between h-52">
          ...
          <Link href="/signin" className="p-6 rounded-2xl bg-gradient-to-b from-[#4d1f5e] to-[#1c0724] text-white hover:scale-[1.02] transition shadow-md flex flex-col justify-between h-52">
      ...
      <footer className="bg-[#161e2e] text-white mt-12 pt-12 pb-8 px-6 text-xs">
        <div className="max-w-6xl mx-auto space-y-8">
          <div className="flex items-center justify-between border-b border-gray-800 pb-6">
            <Link href="/signin" className="px-5 py-2 bg-white text-gray-900 rounded-full font-bold hover:bg-gray-100 transition">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-gray-400">
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/signin" className="hover:underline">What is Cloud Computing?</Link></li>
                <li><Link href="/console" className="hover:underline">AWS Route 53 Basics</Link></li>
                <li><Link href="/console" className="hover:underline">DNS Security (DNSSEC)</Link></li>
              </ul>
            </div>
            <div>
              <h5 className="font-bold text-white mb-3">Resources</h5>
              <ul className="space-y-2">
                <li><Link href="/console" className="hover:underline">Getting Started Resource Center</Link></li>
                <li><Link href="/console" className="hover:underline">AWS Documentation</Link></li>
                <li><Link href="/console" className="hover:underline">Route 53 Pricing</Link></li>
              </ul>
            </div>
            <div>
              <h5 className="font-bold text-white mb-3">Developers</h5>
              <ul className="space-y-2">
                <li><Link href="/console" className="hover:underline">Developer Center</Link></li>
                <li><Link href="/console" className="hover:underline">SDKs & Tools</Link></li>
                <li><Link href="/console" className="hover:underline">Route 53 REST API</Link></li>
              </ul>
            </div>
            <div>
              <h5 className="font-bold text-white mb-3">Help</h5>
              <ul className="space-y-2">
                <li><Link href="/signin" className="hover:underline">Contact Us</Link></li>
                <li><Link href="/signin" className="hover:underline">File a Support Ticket</Link></li>
                <li><Link href="/console" className="hover:underline">Service Health Status</Link></li>
              </ul>
            </div>
          </div>
